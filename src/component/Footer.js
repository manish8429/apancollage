  ...
  return (
    <>
      <div>
        <div
          className="row"
          style={{ marginTop: "3rem", listStyleType: "none", padding: "4rem" }}
        >
          <div className="col-3">
            <span>
              <img
          ...
          <div className="col-3" style={{ fontFamily: "Bol" }}>
            ...
            <li>
              {" "}
              <i class="fa-solid fa-chevron-right"></i> REFUND & <br />{" "}
              CANCELLATION POLICY
            </li>
            <li>
              {" "}
              <i class="fa-solid fa-chevron-right"></i> TERMS & CONDITIONS
            </li>
          </div>
          <div className="col-3">
            ...
            <li>
              <i class="fa-solid fa-user" style={{ paddingRight: "5px" }}></i>
